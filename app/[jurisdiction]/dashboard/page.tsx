            ...
            <section className="mt-4">
              ...
              <div className="mt-3">
                {loading ? (
                  ...
                  <div className="font-mono text-5xl md:text-6xl tabular-nums">
                  ...
                  {vaultState !== "EXPORT_READY" && (
                    <div className="pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity absolute right-0 -top-2 -translate-y-full">
                      <div className="max-w-xs bg-black/90 border border-white/15 text-slate-100 text-[11px] px-3 py-2 rounded-md shadow-lg">
                        Competent Professional sign-off required before export.
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="max-w-md w-full mx-4 bg-[#0a0f1a] border border-[#C9A84C] rounded-2xl p-8 text-center space-y-5">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                Your forensic vault is registered. Complete payment to unlock live evidence capture, AI auditing, and PDF export.
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={handleLockedVaultClick}
              className="w-full py-3 px-6 rounded-xl bg-[#C9A84C] text-black font-semibold text-sm tracking-wide hover:bg-[#d4b560] transition-colors shadow-[0_0_30px_rgba(201,168,76,0.3)]"
            >
